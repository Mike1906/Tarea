...
<%
	...
	boolean exito = ctrl.actualizar(id, nombres, ape1, ape2, idjrv, idtm, user);

	String mensaje;
	
	if (exito) {
		mensaje = "¡¡ Se Atualizo la informacion del Miembro !!";
	}else {
		mensaje = "¡¡ No se pudo Actualizar. No existe ese Miembro !!";
	}
%>
...
<body>
<fieldset>
<legend>Actualiza la informacion del Miembro de la JRV</legend>
  <div class="row">
    <div class="small-8">      
      <div class="row">        
 		<center><%=mensaje%><br><br>
        <a role="button" aria-label="submit form" href="ActualizarMiembrojrv.html" class="button">Actualizar otro miembro</a>
