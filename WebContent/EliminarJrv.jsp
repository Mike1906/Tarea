...
boolean exito=jrv.borrarJrv(Short.valueOf(idjrv));
if (exito==true)
   mensaje="se elimino la JRV correctamente";
else
   mensaje="hubo un error al eliminar la JRV";	
...
<legend>Actualiza la informacion de la JRV</legend>
 ...
 <center><%=mensaje%><br><br>
        <a role="button" aria-label="submit form" href="EliminarJrv.html" class="button">Eliminar otra JRV</a>
